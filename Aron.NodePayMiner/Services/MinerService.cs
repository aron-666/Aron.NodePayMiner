...
namespace Aron.NodePayMiner.Services
{
    public class MinerService : IMinerService
    {
        ...
        private async Task Run()
        {
            try
            {
                ...
                try
                {
                    ...
                    await Task.Delay(3000 + new Random().Next(2100, 6455));
                    ...
                    await Task.Delay(15000 + new Random().Next(2100, 6455));
        ...
        static void AddCookieToLocalStorage(ChromeDriver driver, string npToken)
        {
            ...
            {
                SetLocalStorageItem(driver, key, npToken);
            }
        }
