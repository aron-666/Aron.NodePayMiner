    ...
    public class UpdateJob(MinerRecord _minerRecord) : IJob
    {
        public Task Execute(IJobExecutionContext context)
        {
            try
            {
                ...
                // call https://raw.githubusercontent.com/aron-666/Aron.NodePayMiner/master/Aron.NodePayMiner/Aron.NodePayMiner.csproj to get the latest version
                var latestVersion = new WebClient().DownloadString("https://raw.githubusercontent.com/aron-666/Aron.NodePayMiner/master/Aron.NodePayMiner/Aron.NodePayMiner.csproj");
