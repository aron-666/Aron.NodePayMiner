...
using Aron.NodePayMiner.Data;
using Aron.NodePayMiner.Jobs;
...
internal class Program
{
    private static async Task Main(string[] args)
    {
        ...
        try
        {
            ...
            if (Environment.GetEnvironmentVariables().Contains("NP_TOKEN"))
            {
                appConfig.NpToken = Environment.GetEnvironmentVariable("NP_TOKEN").ToString();
            }
